...
const platforworldIClient = require("../services/platforworldIClient");
...
router.post("/incomplete",isAuthenticated, async (req, res) => {
  ...
  const currentUser = req.currentUser;
    ...
    await platforworldIClient.post(`/v2/payments/${paymentId}/complete`, { txid });
    return res
      .status(200)
...
router.post("/approve", isAuthenticated, async (req, res) => {
  try {
    ...
    const currentPayment = await platforworldIClient.get(
    ...
    await platforworldIClient.post(`/v2/payments/${paymentId}/approve`);
