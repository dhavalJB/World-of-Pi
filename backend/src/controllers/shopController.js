...
const deleteShop = async (req, res) => {
  ...
  try {
    ...
    if (shopToDelete && shopToDelete.owner === currentUser.uid) {
      ...
      console.log(
        "u can't delete this shop since u are not the owner nor admin of world of pi"
      );

      return res.status(401).json({
        message:
          "You can't delete this shop, Since you are not the owner of this shop nor admin of world of pi",
      });
    }
  } catch (error) {
